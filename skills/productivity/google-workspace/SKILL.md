...
### Setup Pitfalls
- **Invalid Flags**: The `setup.py` script does **NOT** support `--services` or `--format json` flags. Using them will result in a usage error. To get the authentication link, use only `python setup.py --auth-url`.
